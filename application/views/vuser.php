  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="module-submenu">
      <ul class="nav navbar-nav navbar-right">
	       ...
	       <?php if ($_SESSION['tipe'] == "sumin" || $_SESSION['tipe'] == "admin"){
	       		echo '<li><a href="#" data-toggle="modal" data-target="#adduser"><i class="glyphicon glyphicon-plus"></i> Entry User Baru</a></li>';
	       } ?>
        <?php endif; ?>
      </ul>
    </div><!-- /.navbar-collapse -->
    ...
    <?php
        if(isset($user)){
            ...
            foreach($user as $u) {
				...
				echo "<td>".$u['status']."</td>";
				echo "<td>".$u['tipe']."</td>";
				if($_SESSION['tipe'] == "sumin" || ($u['tipe'] == 'user' && $_SESSION['tipe'] == "admin")){
					if(($_SESSION['depar'] == $u['depar']) || $_SESSION['tipe'] == "sumin"){
	  ...
	  <div class="modal-body">
		<form id="fadduser" class="form-horizontal" role="form" method="post" action="<?php echo site_url("/admin/adduser"); ?>">
			<div class="form-group">
				...
				<label class="col-sm-2 control-label" for="tipe">Departemen</label>
				<div class="col-sm-10">
      ...
      <div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<label class="form-check-label">
						<input class="form-check-input" type="checkbox" id="modul20" name="modul[backupdb]">
						Backup Database
					</label>
					<label class="from-check-label">
						<input class="frome-check-input" type="checkbox" id="modul21" name="modul[departemen]">
						Departemen
					</label>
				</div>
			</div>
				...
				<div class="col-sm-10">
					<select id="tipe" name="tipe" class="form-control">
						<?php if($_SESSION['tipe'] == "sumin"){
                        	echo '<option value="sumin">Super Admin</option>';
                        } ?>
		...
		<form id="feduser" class="form-horizontal" role="form" method="post" action="<?php echo site_url("/admin/eduser"); ?>">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<label class="form-check-label">
						<input class="form-check-input" type="checkbox" id="emodul20" name="modul[backupdb]">
						Backup Database
					</label>
					<label class="from-check-label">
						<input class="frome-check-input" type="checkbox" id="emodul21" name="modul[departemen]">
						Departemen
					</label>
				</div>
			</div>
