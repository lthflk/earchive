				...
				<tbody>
					<?php
						foreach($data as $a) {
							...
							// hanya user sumin bisa mengubah data sirkulasi
							if(isset($admin) && $admin || isset($sumin) && $sumin && isset($_SESSION['akses_modul']['sirkulasi']) && $_SESSION['akses_modul']['sirkulasi']=='on') {
								if($a['tgl_pengembalian']==null) {
