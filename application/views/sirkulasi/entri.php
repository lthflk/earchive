...
<div class="form-group">
	...
	<input type="text" id="snoarsip" name="noarsip" class="form-control xhr"
	  ...
	  data-xhr="<?php echo site_url('/sirkulasi/xhr_arsip'); ?>" autocomplete="off" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')" />
	</div>
	<div class="col-md-2">
...
<div class="form-group">
	...
	<input type="text" id="username_peminjam" name="username_peminjam" class="form-control xhr" 
	  ...
	  data-xhr="<?php echo site_url('/sirkulasi/xhr_user'); ?>" autocomplete="off" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-8">
	<textarea id="keperluan" name="keperluan" class="form-control" row="3" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"></textarea>
	</div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input id="tgl_pinjam" name="tgl_pinjam" class="form-control input-md" type="text" value="<?php print $now ?>" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</div>
	</div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
    <div class="input-group-addon">(yyyy-mm-dd)</div>
    <input id="tgl_haruskembali" name="tgl_haruskembali" class="form-control input-md" type="text" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</div>
	</div>
</div>
