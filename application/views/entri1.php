...
if($_SESSION['tipe'] != 'sumin')
	{ ?>
		<input type="hidden" name="departemen" value="<?php echo $_SESSION['depar']; ?>">
<?php
	}
?>
	...
	<?php
		if(isset($departemen)){
			foreach($departemen as $k) {
				echo "<option value='".$k['id_dep']."' ".($k['id_dep'] == $_SESSION['depar']?"selected=selected":"").">".$k['nama_dep']."</option>";
										}
							}
	?>
	</select>
...
<div class="form-group">
	...
	<div class="col-md-8">
	<input id="noarsip" name="noarsip" class="form-control input-md" type="text" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input id="tanggal" name="tanggal" class="form-control input-md" type="text" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-8">
	<select id="lokasi_arsip" name="lokasi" class="form-control input-md" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
...
<div class="form-group">
	<label class="col-md-4 control-label" for="lantai">Lantai</label>
	<div class="col-md-8">
	<select id="lantai_arsip" name="lantai" class="form-control input-md" disabled required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</select>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-8">
	<select id="ruangan_arsip" name="ruangan" class="form-control input-md" disabled required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</select>
	</div>
</div>

<div class="form-group">
	<label class="col-md-4 control-label" for="lemari">Lemari</label>
	<div class="col-md-8">
	<select id="lemari_arsip" name="lemari" class="form-control input-md" disabled required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</select>
	</div>
</div>

<div class="form-group">
	<label class="col-md-4 control-label" for="baris">Baris</label>
	<div class="col-md-8">
	<select id="baris_arsip" name="baris" class="form-control input-md" disabled required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
	</select>
	</div>
</div>
...
<div class="form-group">
	<label class="col-md-4 control-label" for="jenisdok">Jenis Data</label>
	<div class="col-md-8">
...
<div class="form-group">
	...
	<p class="help-block">Ukuran Maksimal <?php echo number_format(ceil(max_file_upload_in_bytes()/100000)); ?> MB</p>
	</div>
</div>
