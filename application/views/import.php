...
<div class="row">
	...
	<div class="panel panel-default">
		<div class="panel-heading">Import data <a href="<?php echo base_url('/public/template import digital arsip.xlsx') ?>" class="btn btn-success btn-sm" id="export">File template</a></div>
		<div class="panel-body">
			<form id="import_data" action="<?php echo site_url('/admin/importdata') ?>" enctype="multipart/form-data" class="form-horizontal" method="post" role="form">
				...
				<input type="file" name="up_file" id="up_file" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"/>
				<input type="submit" style="color: initial" value="Upload" class="submit" />
			</form>
		</div>
	</div>
</div>